...
url <- "https://data.bn.org.pl/api/institutions/bibs.marcxml?limit=30&amp;title=Krytyka+Czystego+Rozumu"
...
```{r}
book_entry<-tibble(book_id,title,author,ISBN,OCLC,publisher, publish_place=NA,publish_year, pages=NA, language, original_language, original_title, translator)
```
