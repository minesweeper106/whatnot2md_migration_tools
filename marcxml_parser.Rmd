...
url <- "https://data.bn.org.pl/api/institutions/bibs.marcxml?title=Krytyka+Czystego+Rozumu"
...
```{r}
book_entry<-tibble(book_id,title,author,ISBN,OCLC,publisher, publish_place,publish_year, pages, language, original_language, original_title, translator)
```
